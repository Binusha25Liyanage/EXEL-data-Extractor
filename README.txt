CRUCIBLE - Report Builder (Desktop GUI App)
=================================================
...
- Windows: double-click Run_Crucible.bat (shows a console window
  briefly; pauses on error so you can read it) - or
  Run_Crucible_Silent.vbs for no console window at all, closer to a
  real installed app. To put either on your Desktop: right-click it >
  Send to > Desktop (create shortcut).
- macOS/Linux: Run_Crucible.command - first run, either right-click >
  Open, or in Terminal: chmod +x Run_Crucible.command
